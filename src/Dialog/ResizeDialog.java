...
public class ResizeDialog extends javax.swing.JDialog {
    ...
    public ResizeDialog(java.awt.Frame parent, boolean modal, int width, int height) {
        super(parent, modal);
        initComponents();
        this.width = width;
        this.height = height;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder("Information"), "Resize Image"));

        jLabel1.setText("Width : ");

        jLabel2.setText("Height : ");

        btnResize.setBackground(new java.awt.Color(255, 255, 255));
        btnResize.setText("Resize Image");
