...
public class BorderDialog extends javax.swing.JDialog {

    public String selectedFileName = "0";
    
    public BorderDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Choose Border");
    ...
    private void initComponents() {
        ...
        lb1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/1.png"))); // NOI18N
        lb1.setName("1"); // NOI18N

        lb2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/2.png"))); // NOI18N
        lb2.setName("2"); // NOI18N

        lb3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/3.png"))); // NOI18N
        lb3.setName("3"); // NOI18N

        lb4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/4.png"))); // NOI18N
        lb4.setName("4"); // NOI18N

        lb5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/5.png"))); // NOI18N
        lb5.setName("5"); // NOI18N

        lb6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/6.png"))); // NOI18N
        lb6.setName("6"); // NOI18N

        lb7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/7.png"))); // NOI18N
        lb7.setName("7"); // NOI18N

        lb8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/8.png"))); // NOI18N
        lb8.setName("8"); // NOI18N

        lb9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BorderThumb/9.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lb6, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
